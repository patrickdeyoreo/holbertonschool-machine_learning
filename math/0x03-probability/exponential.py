...
class Exponential:
    ...
    def data(self):
        """
        Gets the data attribute of a exponential distribution
        Return:
            data
        """
        return self.__data
    ...
    def data(self, value):
        """
        Sets the data attribute of a exponential distribution
        Arguments:
    ...
    def lambtha(self):
        """
        Gets the lambtha attribute of a exponential distribution
        Return:
            lambtha
        """
    ...
    def lambtha(self, value):
        """
        Sets the lambtha attribute of a exponential distribution
        Arguments:
